...
export default function Home() {
  ...
  if (!isOpened) {
    return <OpeningScreen onOpen={() => setIsOpened(true)} />;
  }

  return (
    <main className="relative min-h-screen w-full overflow-hidden fade-in-dark">
      {/* Background kiri */}
      <div className="hidden md:flex fixed top-0 left-0 md:w-1/2 lg:w-3/4 h-screen z-0 items-center justify-center">
